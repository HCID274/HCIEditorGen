...
static bool HCI_BuildKeywordPlan(
	...
	FString& OutError)
{
	FHCIAbilityKitKeywordPlannerProvider Provider;
...
static void HCI_FinishAsyncWithFailure(const TSharedRef<FHCIAbilityKitAsyncPlanBuildState, ESPMode::ThreadSafe>& State)
{
	FHCIAbilityKitAgentPlannerResultMetadata Metadata;
	...
	HCI_CompleteAsyncPlanBuild(State, false, FHCIAbilityKitAgentPlan(), FString(), MoveTemp(Metadata), MoveTemp(State->LastError));
}
