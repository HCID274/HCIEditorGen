...
|               `-- Private/
|                   |-- HCIAbilityKitEditorModule.cpp        # 启动注册 Python Hook + Reimport 菜单 + Search/AuditScan/AuditExportJson/AuditScanAsync(+Stop/Retry)+ToolRegistryDump+DryRunDiffPreview+AgentConfirmGateDemo+AgentBlastRadiusDemo+AgentTransactionDemo+AgentSourceControlDemo 控制台命令
|                   |-- Audit/
...
|                       `-- HCIAbilityKitAgentExecutionGateTests.cpp # StageE-E3/E4/E5 自动化测试（Confirm/BlastRadius/Transaction）
|                       |-- HCIAbilityKitAgentExecutionGateTests.cpp # StageE-E3/E4 自动化测试（确认门禁 + Blast Radius 限流）
