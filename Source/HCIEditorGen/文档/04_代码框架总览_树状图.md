...
|               `-- Private/
|                   |-- HCIAbilityKitEditorModule.cpp        # 启动注册 Python Hook + Reimport 菜单 + Search/AuditScan/AuditExportJson/AuditScanAsync(+Stop/Retry)+ToolRegistryDump+DryRunDiffPreview+AgentConfirmGate/BlastRadius/Transaction/SourceControl/Rbac/LodSafetyDemo+AgentPlanDemo(+Json)+AgentPlanValidateDemo 控制台命令
|                   |-- Audit/
