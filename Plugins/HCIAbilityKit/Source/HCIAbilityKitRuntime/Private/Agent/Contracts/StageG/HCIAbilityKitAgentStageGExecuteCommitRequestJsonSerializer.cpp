...
bool FHCIAbilityKitAgentStageGExecuteCommitRequestJsonSerializer::SerializeToJsonString(
	...
	FString& OutJsonText)
{
	...
	Root->SetStringField(TEXT("stage_g_execute_dispatch_receipt_id"), Request.StageGExecuteDispatchReceiptId);
	Root->SetStringField(TEXT("stage_g_execute_dispatch_request_id"), Request.StageGExecuteDispatchRequestId);
	...
	Root->SetStringField(TEXT("stage_g_execute_dispatch_receipt_digest"), Request.StageGExecuteDispatchReceiptDigest);
	Root->SetStringField(TEXT("stage_g_execute_commit_request_digest"), Request.StageGExecuteCommitRequestDigest);
	...
	Root->SetStringField(TEXT("stage_g_execute_dispatch_receipt_status"), Request.StageGExecuteDispatchReceiptStatus);
	Root->SetStringField(TEXT("stage_g_execute_commit_request_status"), Request.StageGExecuteCommitRequestStatus);
	...
	Root->SetBoolField(TEXT("stage_g_execute_dispatch_accepted"), Request.bStageGExecuteDispatchAccepted);
	Root->SetBoolField(TEXT("stage_g_execute_dispatch_receipt_ready"), Request.bStageGExecuteDispatchReceiptReady);
	Root->SetBoolField(TEXT("execute_commit_confirmed"), Request.bExecuteCommitConfirmed);
	Root->SetBoolField(TEXT("stage_g_execute_commit_request_ready"), Request.bStageGExecuteCommitRequestReady);
