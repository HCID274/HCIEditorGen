...
namespace
{
static const FHCIAgentPlanStep* FindStepByToolName(const FHCIAgentPlan& Plan, const TCHAR* ToolName)
{
	return Plan.Steps.FindByPredicate(
		[ToolName](const FHCIAgentPlanStep& Step)
		{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FHCIAgentPlanNamingIntentTest,
	"HCI.Editor.AgentPlan.PlannerSupportsNamingArchiveIntent",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FHCIAgentPlanNamingIntentTest::RunTest(const FString& Parameters)
{
	...
	FString RouteReason;
	FString Error;
	const bool bOk = FHCIAgentPlanner::BuildPlanFromNaturalLanguage(
	...
	const FHCIAgentPlanStep* Step = FindStepByToolName(Plan, TEXT("NormalizeAssetNamingByMetadata"));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FHCIAgentPlanLevelRiskIntentTest,
	"HCI.Editor.AgentPlan.PlannerSupportsLevelRiskIntent",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FHCIAgentPlanLevelRiskIntentTest::RunTest(const FString& Parameters)
{
	FHCIToolRegistry& Registry = FHCIToolRegistry::Get();
	Registry.ResetToDefaults();
	...
	const FHCIAgentPlanStep* Step = FindStepByToolName(Plan, TEXT("ScanLevelMeshRisks"));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FHCIAgentPlanMeshTriangleCountIntentTest,
	"HCI.Editor.AgentPlan.PlannerSupportsMeshTriangleCountIntent",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FHCIAgentPlanMeshTriangleCountIntentTest::RunTest(const FString& Parameters)
{
	FHCIToolRegistry& Registry = FHCIToolRegistry::Get();
	Registry.ResetToDefaults();
	...
	const FHCIAgentPlanStep* Step = FindStepByToolName(Plan, TEXT("ScanMeshTriangleCount"));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FHCIAgentPlanMinimalContractAllowsAssistantMessageOnlyTest,
	"HCI.Editor.AgentPlan.ContractAllowsAssistantMessageOnlyPlan",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FHCIAgentPlanMinimalContractAllowsAssistantMessageOnlyTest::RunTest(const FString& Parameters)
{
	FHCIAgentPlan Plan;
	Plan.PlanVersion = 1;
	...
	FString Error;
	TestTrue(TEXT("Minimal contract should allow assistant_message-only plan"), FHCIAgentPlanContract::ValidateMinimalContract(Plan, Error));
	TestTrue(TEXT("Contract error should be empty"), Error.IsEmpty());
	return true;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FHCIAgentPlanJsonSerializerCoreFieldsTest,
	"HCI.Editor.AgentPlan.JsonSerializerIncludesCoreContractFields",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FHCIAgentPlanJsonSerializerCoreFieldsTest::RunTest(const FString& Parameters)
{
	FHCIToolRegistry& Registry = FHCIToolRegistry::Get();
	Registry.ResetToDefaults();
	...
	FString JsonText;
	TestTrue(TEXT("Serializer should succeed"), FHCIAgentPlanJsonSerializer::SerializeToJsonString(Plan, JsonText));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FHCIAgentPlanJsonSerializerAssistantMessageTest,
	"HCI.Editor.AgentPlan.JsonSerializerIncludesAssistantMessageWhenPresent",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FHCIAgentPlanJsonSerializerAssistantMessageTest::RunTest(const FString& Parameters)
{
	FHCIAgentPlan Plan;
	Plan.PlanVersion = 1;
