...
|               `-- Private/
|                   |-- HCIAbilityKitEditorModule.cpp        # 启动注册 Python Hook + Reimport 菜单 + Search/AuditScan/AuditExportJson/AuditScanAsync(+Stop/Retry)+ToolRegistryDump+DryRunDiffPreview+AgentConfirmGateDemo+AgentBlastRadiusDemo+AgentTransactionDemo 控制台命令
|                   |-- Audit/
