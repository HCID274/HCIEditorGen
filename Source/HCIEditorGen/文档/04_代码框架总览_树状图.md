...
|                   |   `-- HCIAbilityKitAgentDemoConsoleCommands.cpp # Refactor-R2 Agent*Demo 命令实现与注册（E3~E8/F1~F3）
|                   |-- Factories/
...
|                       |-- HCIAbilityKitAgentExecutorTests.cpp # StageF-F3 自动化测试（执行器骨架成功路径/预检拒绝/证据键覆盖）
