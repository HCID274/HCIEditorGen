...
static FString HCI_BuildStageGExecuteFinalReportDigest_G7(const FHCIAbilityKitAgentStageGExecuteFinalReport& Receipt)
{
	FString Canonical;
	Canonical += FString::Printf(
...
static void HCI_CopyCommitReceiptToFinalReport_G8(
	const FHCIAbilityKitAgentStageGExecuteCommitReceipt& InReceipt,
	FHCIAbilityKitAgentStageGExecuteFinalReport& OutReceipt)
{
	OutReceipt = FHCIAbilityKitAgentStageGExecuteFinalReport();
...
bool FHCIAbilityKitAgentExecutorStageGExecuteFinalReportBridge::BuildStageGExecuteFinalReport(
