...
namespace
{
static FString HCI_BuildSelectionDigestFromReviewReport_F15(const FHCIDryRunDiffReport& Report)
{
	FString Canonical;
...
static FString HCI_BuildHandoffDigest_F15(const FHCIAgentSimulateExecuteHandoffEnvelope& Envelope)
{
	FString Canonical;
	Canonical += FString::Printf(
...
{
	OutEnvelope = FHCIAgentSimulateExecuteHandoffEnvelope();
	...
	OutEnvelope.GeneratedUtc = FHCITimeFormat::FormatNowBeijingIso8601();
...
bool FHCIAgentExecutorSimulateExecuteHandoffEnvelopeBridge::BuildSimulateExecuteHandoffEnvelope(
	const FHCIAgentSimulateExecuteArchiveBundle& SimArchiveBundle,
