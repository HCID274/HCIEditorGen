...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FHCISearchPathFuzzyMatchTest,
	"HCI.Editor.AgentTools.SearchPathFuzzyMatchesUnderscoreDirectory",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FHCISearchPathFuzzyMatchTest::RunTest(const FString& Parameters)
{
	...
	TMap<FName, TSharedPtr<IHCIAgentToolAction>> Actions;
	HCIAgentToolActions::BuildStageIDraftActions(Actions);
	const TSharedPtr<IHCIAgentToolAction>* SearchAction = Actions.Find(TEXT("SearchPath"));
	...
	FHCIAgentToolActionRequest Request;
	...
	FHCIAgentToolActionResult Result;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FHCISearchPathSemanticKeywordAliasTest,
	"HCI.Editor.AgentTools.SearchPathSemanticKeywordAliasMatchesTempDirectory",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FHCISearchPathSemanticKeywordAliasTest::RunTest(const FString& Parameters)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FHCIRenameAssetExecuteTest,
	"HCI.Editor.AgentTools.RenameAssetExecuteRenamesRealAsset",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FHCIScanLevelMeshRisksSelectedWithoutSelectionFailsTest,
	"HCI.Editor.AgentTools.ScanLevelMeshRisksSelectedWithoutSelectionFails",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FHCISetTextureMaxSizeExecuteTest,
	"HCI.Editor.AgentTools.SetTextureMaxSizeExecuteModifiesRealTexture",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FHCISetMeshLODGroupExecuteTest,
	"HCI.Editor.AgentTools.SetMeshLODGroupExecuteModifiesRealStaticMesh",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FHCISetMeshLODGroupNaniteBlockedTest,
	"HCI.Editor.AgentTools.SetMeshLODGroupExecuteBlocksNaniteMesh",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FHCIScanMeshTriangleCountDryRunTest,
	"HCI.Editor.AgentTools.ScanMeshTriangleCountDryRunReturnsMeshTriangleEvidence",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FHCINormalizeNamingDryRunTest,
	"HCI.Editor.AgentTools.NormalizeAssetNamingByMetadataDryRunBuildsProposals",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FHCINormalizeNamingExecuteTest,
	"HCI.Editor.AgentTools.NormalizeAssetNamingByMetadataExecuteRenamesAndMovesAssets",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FHCIScanLevelMeshRisksSelectedWithoutSelectionFailsTest::RunTest(const FString& Parameters)
{
	if (GEditor != nullptr)
	{
	...
	TMap<FName, TSharedPtr<IHCIAgentToolAction>> Actions;
	HCIAgentToolActions::BuildStageIDraftActions(Actions);
	const TSharedPtr<IHCIAgentToolAction>* ScanAction = Actions.Find(TEXT("ScanLevelMeshRisks"));
...
bool FHCISetTextureMaxSizeExecuteTest::RunTest(const FString& Parameters)
{
	...
	TMap<FName, TSharedPtr<IHCIAgentToolAction>> Actions;
	HCIAgentToolActions::BuildStageIDraftActions(Actions);
	const TSharedPtr<IHCIAgentToolAction>* TextureAction = Actions.Find(TEXT("SetTextureMaxSize"));
...
bool FHCISetMeshLODGroupExecuteTest::RunTest(const FString& Parameters)
{
	...
	TMap<FName, TSharedPtr<IHCIAgentToolAction>> Actions;
	HCIAgentToolActions::BuildStageIDraftActions(Actions);
	const TSharedPtr<IHCIAgentToolAction>* LodAction = Actions.Find(TEXT("SetMeshLODGroup"));
...
bool FHCIScanMeshTriangleCountDryRunTest::RunTest(const FString& Parameters)
{
	...
	TMap<FName, TSharedPtr<IHCIAgentToolAction>> Actions;
	HCIAgentToolActions::BuildStageIDraftActions(Actions);
	const TSharedPtr<IHCIAgentToolAction>* ScanAction = Actions.Find(TEXT("ScanMeshTriangleCount"));
	if (ScanAction == nullptr || !ScanAction->IsValid())
	{
		HCI_DeleteAssetIfExists(MeshAssetPath);
		HCI_DeleteAssetIfExists(TextureAssetPath);
...
bool FHCINormalizeNamingDryRunTest::RunTest(const FString& Parameters)
{
	...
	TMap<FName, TSharedPtr<IHCIAgentToolAction>> Actions;
	HCIAgentToolActions::BuildStageIDraftActions(Actions);
	const TSharedPtr<IHCIAgentToolAction>* NamingAction = Actions.Find(TEXT("NormalizeAssetNamingByMetadata"));
...
bool FHCINormalizeNamingExecuteTest::RunTest(const FString& Parameters)
{
...
bool FHCISetMeshLODGroupNaniteBlockedTest::RunTest(const FString& Parameters)
{
...
bool FHCIRenameAssetExecuteTest::RunTest(const FString& Parameters)
{
	...
	TMap<FName, TSharedPtr<IHCIAgentToolAction>> Actions;
	HCIAgentToolActions::BuildStageIDraftActions(Actions);
	const TSharedPtr<IHCIAgentToolAction>* RenameAction = Actions.Find(TEXT("RenameAsset"));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FHCIMoveAssetExecuteTest,
	"HCI.Editor.AgentTools.MoveAssetExecuteMovesRealAsset",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FHCIMoveAssetExecuteTest::RunTest(const FString& Parameters)
{
	...
	TMap<FName, TSharedPtr<IHCIAgentToolAction>> Actions;
	HCIAgentToolActions::BuildStageIDraftActions(Actions);
	const TSharedPtr<IHCIAgentToolAction>* MoveAction = Actions.Find(TEXT("MoveAsset"));
