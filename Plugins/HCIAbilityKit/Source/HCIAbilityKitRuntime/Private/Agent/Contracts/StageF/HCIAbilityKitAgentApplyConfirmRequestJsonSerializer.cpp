...
bool FHCIAbilityKitAgentApplyConfirmRequestJsonSerializer::SerializeToJsonString(
	const FHCIAbilityKitAgentApplyConfirmRequest& Request,
	FString& OutJsonText)
{
	...
	Root->SetBoolField(TEXT("ready_to_execute"), Request.bReadyToExecute);
