...
class FHCIAbilityKitEvidenceContext_Default final : public IHCIAbilityKitEvidenceContextView
{
public:
	explicit FHCIAbilityKitEvidenceContext_Default(const TMap<FString, TMap<FString, FString>>& InStepEvidenceContext)
