...
// Moved: heavy session logic lives in UHCIAbilityKitAgentSessionController (Subsystem stays as thin Facade).
...
void UHCIAbilityKitAgentSessionController::Initialize(UHCIAbilityKitAgentSubsystem& InOwner)
{
...
void UHCIAbilityKitAgentSessionController::Deinitialize()
{
...
bool UHCIAbilityKitAgentSessionController::SubmitChatInput(const FString& UserInput, const FString& SourceTag)
{
...
bool UHCIAbilityKitAgentSessionController::IsBusy() const
{
	return ActiveCommand != nullptr;
}

bool UHCIAbilityKitAgentSessionController::HasLastPlan() const
{
	return bHasLastPlan;
}

EHCIAbilityKitAgentSessionState UHCIAbilityKitAgentSessionController::GetCurrentState() const
{
	return CurrentState;
}

FString UHCIAbilityKitAgentSessionController::GetCurrentStateLabel() const
{
	return HCI_SessionStateToLabel(CurrentState);
}

bool UHCIAbilityKitAgentSessionController::CanCommitLastPlanFromChat() const
{
	return bHasLastPlan && CurrentState == EHCIAbilityKitAgentSessionState::AwaitUserConfirm;
}

bool UHCIAbilityKitAgentSessionController::CanCancelPendingPlanFromChat() const
{
	return bHasLastPlan && CurrentState == EHCIAbilityKitAgentSessionState::AwaitUserConfirm;
}

void UHCIAbilityKitAgentSessionController::GetCurrentProgressState(FHCIAbilityKitAgentUiProgressState& OutState) const
{
	OutState = CurrentProgressState;
}

void UHCIAbilityKitAgentSessionController::GetCurrentActivityHint(FString& OutHint) const
{
	OutHint = CurrentActivityHint;
}

void UHCIAbilityKitAgentSessionController::GetLastExecutionLocateTargets(TArray<FHCIAbilityKitAgentUiLocateTarget>& OutTargets) const
{
	OutTargets = LastExecutionLocateTargets;
}

bool UHCIAbilityKitAgentSessionController::BuildLastPlanCardLines(TArray<FString>& OutLines) const
{
	OutLines.Reset();
	if (!bHasLastPlan)
	{
	...
	if (CurrentState == EHCIAbilityKitAgentSessionState::AwaitUserConfirm && UHCIAbilityKitAgentSubsystem::IsWriteLikePlan(LastPlan))
	{
		...
		for (const FHCIAbilityKitAgentPlanStep& Step : LastPlan.Steps)
		{
			...
			const FString IntentReason = UHCIAbilityKitAgentSubsystem::BuildStepIntentReasonForUi(Step);
			const FString RiskWarning = UHCIAbilityKitAgentSubsystem::BuildStepRiskWarningForUi(Step);
...
bool UHCIAbilityKitAgentSessionController::BuildLastPlanApprovalCard(FHCIAbilityKitAgentUiApprovalCard& OutCard) const
{
	...
	OutCard.KeyAction = HCI_SanitizeUiTextForArtist(UHCIAbilityKitAgentSubsystem::BuildStepDisplaySummaryForUi(*BestStep));
	OutCard.ImpactHint = HCI_SanitizeUiTextForArtist(UHCIAbilityKitAgentSubsystem::BuildStepImpactHintForUi(*BestStep));
	...
	{
		OutCard.Warning = HCI_SanitizeUiTextForArtist(UHCIAbilityKitAgentSubsystem::BuildStepRiskWarningForUi(*BestStep));
	}
...
bool UHCIAbilityKitAgentSessionController::OpenLastPlanPreview()
{
	if (!bHasLastPlan)
	{
...
bool UHCIAbilityKitAgentSessionController::CommitLastPlanFromChat()
{
	if (ActiveCommand != nullptr)
	{
		EmitStatus(TEXT("状态：忙碌"));
...
bool UHCIAbilityKitAgentSessionController::CancelPendingPlanFromChat()
{
	if (ActiveCommand != nullptr)
	{
		EmitStatus(TEXT("状态：忙碌"));
...
bool UHCIAbilityKitAgentSessionController::TryLocateLastExecutionTargetByIndex(const int32 TargetIndex)
{
...
void UHCIAbilityKitAgentSessionController::ReloadQuickCommands()
{
	FString Error;
...
const TArray<FHCIAbilityKitAgentQuickCommand>& UHCIAbilityKitAgentSessionController::GetQuickCommands() const
{
	return QuickCommands;
}

const FString& UHCIAbilityKitAgentSessionController::GetQuickCommandsLoadError() const
{
	return QuickCommandsLoadError;
}

void UHCIAbilityKitAgentSessionController::EmitUserLine(const FString& Text)
{
	if (UHCIAbilityKitAgentSubsystem* Owner = OwnerSubsystem.Get())
	{
		Owner->OnChatLine.Broadcast(FString::Printf(TEXT("你：%s"), *Text));
	}
}

void UHCIAbilityKitAgentSessionController::EmitAssistantLine(const FString& Text)
{
	if (UHCIAbilityKitAgentSubsystem* Owner = OwnerSubsystem.Get())
	{
...
void UHCIAbilityKitAgentSessionController::EmitStatus(const FString& Text)
{
	if (UHCIAbilityKitAgentSubsystem* Owner = OwnerSubsystem.Get())
	{
...
void UHCIAbilityKitAgentSessionController::SetProgressState(const FHCIAbilityKitAgentUiProgressState& InState)
{
...
void UHCIAbilityKitAgentSessionController::SetActivityHint(const FString& InHint)
{
...
void UHCIAbilityKitAgentSessionController::ClearLocateTargets()
{
	LastExecutionLocateTargets.Reset();
	if (UHCIAbilityKitAgentSubsystem* Owner = OwnerSubsystem.Get())
	{
...
void UHCIAbilityKitAgentSessionController::SetLocateTargetsFromExecutionReport(const FHCIAbilityKitAgentPlanExecutionReport& Report)
{
	LastExecutionLocateTargets.Reset();
...
void UHCIAbilityKitAgentSessionController::SetCurrentState(const EHCIAbilityKitAgentSessionState NewState)
{
...
FString UHCIAbilityKitAgentSessionController::BuildStateStatusText(const EHCIAbilityKitAgentSessionState State) const
{
	switch (State)
	{
	case EHCIAbilityKitAgentSessionState::Idle:
...
bool UHCIAbilityKitAgentSessionController::ExecuteLastPlan(
...
void UHCIAbilityKitAgentSessionController::HandleCommandCompleted(const FHCIAbilityKitAgentCommandResult& Result)
{
	ActiveCommand = nullptr;
	...
	const EHCIAbilityKitAgentPlanExecutionBranch Branch = UHCIAbilityKitAgentSubsystem::ClassifyPlanExecutionBranch(LastPlan);
...
bool UHCIAbilityKitAgentSessionController::ExecuteRegisteredCommand(
	...
	const FHCIAbilityKitAgentCommandContext& Context)
{
	...
	Command->ExecuteAsync(
		...
		FHCIAbilityKitAgentCommandComplete::CreateUObject(
			this,
			&UHCIAbilityKitAgentSessionController::HandleCommandCompleted));
	return true;
}
