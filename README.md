# HCIEditorGen（UE5 工具链作品集 Demo）— HCIAbilityKit

> UE 5.4 校招实习作品集 Demo（中文）  
> 关键词：UE 编辑器工具 / Technical Art / 资产合规审计 / AI 辅助规划 / Dry-Run Diff / 安全执行门禁 / 批量处理

（TODO：在这里插入 GitHub Video / Release Assets / 外链视频）

---

## 这个项目解决什么问题？

面向美术/TA 的编辑器内工具化管线：把“**大批量资产合规检查**”与“**受控的批量修复**”做成一条可审阅、可回滚的闭环，减少重复性劳动并降低改错成本。
...
- `HCI.ToolRegistryDump`  
  打印冻结的 Tool Registry 能力声明（面试官很爱看这种“契约化”）。
