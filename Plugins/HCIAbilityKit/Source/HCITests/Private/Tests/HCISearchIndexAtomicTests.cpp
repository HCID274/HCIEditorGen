...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FHCISearchIndexAtomicRefreshRollbackTest,
	"HCI.Editor.SearchIndex.AtomicRefreshRollback",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FHCISearchIndexAtomicRemoveStaleMappingGuardTest,
	"HCI.Editor.SearchIndex.AtomicRemoveStaleMappingGuard",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FHCISearchIndexAtomicRefreshRollbackTest::RunTest(const FString& Parameters)
{
	...
	UHCIAsset* AssetA = NewObject<UHCIAsset>(GetTransientPackage(), FName(*AssetNameA), RF_Transient);
	UHCIAsset* AssetB = NewObject<UHCIAsset>(GetTransientPackage(), FName(*AssetNameB), RF_Transient);
...
bool FHCISearchIndexAtomicRemoveStaleMappingGuardTest::RunTest(const FString& Parameters)
{
	FHCISearchIndexService& Service = FHCISearchIndexService::Get();
